...
export default function FiturCepat() {
  return (
    <section className="pt-12 pb-24 bg-gray-50 relative z-10">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="mb-10 text-center">
          <h2 className="text-3xl font-extrabold text-gray-900 mb-3 tracking-tight">Akses Cepat</h2>
          <p className="text-gray-500 max-w-xl mx-auto">Pilih layanan atau informasi yang ingin Anda akses dengan cepat dan mudah.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            <a href="https://quran.kemenag.go.id/" target="_blank" rel="noopener noreferrer" className="group bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-4 relative z-10">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 text-lg group-hover:text-blue-600 transition-colors">Al-Qur'an Online</h3>
                </div>
              </div>
              <p className="text-gray-500 text-sm relative z-10">Baca Al-Qur'an dan terjemahannya dari portal resmi Kemenag RI.</p>
            </a>

            <Link href="/kegiatan" className="group bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
              <div className="absolute -right-6 -bottom-6 text-gray-50 opacity-50 group-hover:scale-110 transition-transform">
              ...
              <div className="flex items-center gap-4 mb-4 relative z-10">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 text-lg group-hover:text-yellow-600 transition-colors">Agenda</h3>
                </div>
              </div>
              <p className="text-gray-500 text-sm relative z-10">Jadwal kegiatan dan kajian rutin yang akan datang.</p>
            </Link>
          </div>
        </div>
      </div>
