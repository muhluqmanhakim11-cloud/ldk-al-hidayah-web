        ...
        {publishedGalleries.length > 0 ? (
          <div className="space-y-16">
            {publishedGalleries.map(gallery => (
              <section key={gallery.id} className="bg-white border rounded-2xl p-6 md:p-8 shadow-sm">
                ...
                {gallery.images && gallery.images.length > 0 ? (
                  ...
                  <div className="text-center py-8 bg-gray-50 rounded-lg border border-dashed">
                    <p className="text-gray-500">Belum ada foto dalam galeri ini.</p>
                  </div>
                )}
              </section>
            ))}
          ...
          <div className="text-center p-12 bg-white border border-dashed rounded-xl shadow-sm">
            ...
            <h3 className="text-lg font-medium text-gray-900">Belum ada galeri</h3>
            <p className="mt-1 text-gray-500">Album dokumentasi belum tersedia saat ini.</p>
          </div>
        )}
      </div>
    </div>
