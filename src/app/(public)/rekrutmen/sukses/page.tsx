...
export default function SuksesPage() {
  return (
    <div className="bg-gray-50 dark:bg-slate-950 min-h-[70vh] flex items-center justify-center py-20">
      <div className="bg-white dark:bg-slate-900 p-10 rounded-2xl shadow-sm border max-w-lg w-full text-center">
        ...
        <div className="space-y-4">
          ...
          <Link href="/rekrutmen" className="block w-full bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 font-bold py-3 px-4 rounded-md hover:bg-gray-200 dark:bg-slate-700 transition-colors">
