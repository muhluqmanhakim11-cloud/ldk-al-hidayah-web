  ...
  return (
    <div className="bg-gray-50 pb-20">
      ...
      <section className="relative bg-green-900 text-white overflow-hidden">
        ...
        <div className="container relative z-20 mx-auto px-4 lg:px-8 pt-32 pb-24 md:pt-40 md:pb-32 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            {isRecruitmentOpen ? (
              <Link href="/rekrutmen/daftar" className="bg-white text-green-900 px-8 py-4 rounded-full font-bold hover:bg-green-50 hover:scale-105 transition-all shadow-xl text-center">
      ...
      <section id="why-us" className="py-20 bg-white">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Mengapa Harus Bergabung?</h2>
            <p className="text-gray-600 text-lg">Bukan sekadar organisasi, kami menawarkan ekosistem pengembangan diri yang komprehensif.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-green-50 rounded-2xl border border-green-100 text-center hover:-translate-y-2 transition-transform duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Tarbiyah & Kerohanian</h3>
              <p className="text-gray-600">Perkuat iman dan pengetahuan agama Islam melalui kajian rutin, tahsin, dan mentoring eksklusif.</p>
            </div>
            ...
            <div className="p-8 bg-green-50 rounded-2xl border border-green-100 text-center hover:-translate-y-2 transition-transform duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Networking Solid</h3>
              <p className="text-gray-600">Bangun relasi dengan mahasiswa berprestasi dari berbagai fakultas dan alumni yang tersebar luas.</p>
            </div>
            ...
            <div className="p-8 bg-green-50 rounded-2xl border border-green-100 text-center hover:-translate-y-2 transition-transform duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Upgrade Kapasitas</h3>
              <p className="text-gray-600">Pelatihan kepemimpinan, public speaking, desain, jurnalistik, dan manajemen event.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50 border-t">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Pilih Bidang Kesukaanmu</h2>
            <p className="text-gray-600 text-lg">Temukan wadah aktualisasi diri yang paling sesuai dengan passion dan potensimu.</p>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {activeDivisions.length > 0 ? activeDivisions.map(div => (
              <div key={div.id} className="bg-white p-6 rounded-xl shadow-sm border hover:border-green-400 hover:shadow-md transition-all group">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-green-100 text-green-700 rounded-full flex items-center justify-center font-bold mr-4 group-hover:bg-green-600 group-hover:text-white transition-colors">
                    {div.name.charAt(0)}
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 group-hover:text-green-700 transition-colors">{div.name}</h3>
                </div>
              ...
              <div className="col-span-full text-center text-gray-500 p-8 border border-dashed rounded-xl">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="flex-1">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 border-b-4 border-green-500 inline-block pb-2">Timeline Rekrutmen</h2>
              <div className="relative border-l-2 border-green-200 ml-3 md:ml-6 mt-8 space-y-10">
                <div className="relative pl-8">
                  ...
                  <h3 className="font-bold text-lg text-gray-900">Pendaftaran Online</h3>
                  <p className="text-gray-500 text-sm mt-1">Mengisi formulir melalui website resmi.</p>
                </div>
                <div className="relative pl-8">
                  <span className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-gray-300 ring-4 ring-white"></span>
                  <h3 className="font-bold text-lg text-gray-900">Seleksi Berkas</h3>
                  <p className="text-gray-500 text-sm mt-1">Peninjauan dan validasi oleh Admin Bidang.</p>
                </div>
                <div className="relative pl-8">
                  <span className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-gray-300 ring-4 ring-white"></span>
                  <h3 className="font-bold text-lg text-gray-900">Wawancara (Opsional)</h3>
                  <p className="text-gray-500 text-sm mt-1">Sesi pengenalan lebih lanjut via online/offline.</p>
                </div>
                <div className="relative pl-8">
                  <span className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-gray-300 ring-4 ring-white"></span>
                  <h3 className="font-bold text-lg text-gray-900">Pengumuman Kelulusan</h3>
                  <p className="text-gray-500 text-sm mt-1">Disampaikan melalui WhatsApp dan Email.</p>
                </div>
              </div>
            </div>

            <div className="flex-1 bg-gray-50 p-8 rounded-2xl border">
              ...
              <div className="mt-10 pt-8 border-t text-center">
                <h3 className="font-semibold text-gray-900 mb-4">Punya pertanyaan lain?</h3>
      ...
      <section className="bg-green-800 text-white py-20 text-center">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          {isRecruitmentOpen ? (
            <Link href="/rekrutmen/daftar" className="inline-block bg-white text-green-900 px-10 py-4 rounded-full font-bold hover:scale-105 transition-transform shadow-2xl text-lg">
