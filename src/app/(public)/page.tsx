      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-950 text-white">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="inline-block px-4 py-1.5 rounded-full bg-black/30 border border-white/20 backdrop-blur-md text-green-50 font-semibold text-sm mb-4 animate-fade-in-up shadow-lg">
              <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse inline-block mr-2"></span>
              UKM Kerohanian Islam STMIK IKMI
            </div>
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-[1.1] animate-fade-in-up drop-shadow-2xl" style={{ animationDelay: '0.1s' }}>
            ...
            <p className="text-lg md:text-xl text-green-50/90 max-w-2xl mx-auto leading-relaxed animate-fade-in-up drop-shadow-lg" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
              <Link href="/rekrutmen" className="btn-ripple w-full sm:w-auto px-8 py-3.5 rounded-full bg-green-600 text-white font-bold hover:bg-green-500 hover:scale-105 hover:shadow-xl hover:shadow-green-500/30 transition-all duration-300 active:scale-95 shadow-lg">
                Bergabung Sekarang
              </Link>
              <Link href="/profil" className="btn-ripple w-full sm:w-auto px-8 py-3.5 rounded-full bg-black/40 border border-white/30 backdrop-blur-md text-white font-semibold hover:bg-black/60 transition-all duration-300 active:scale-95">
                Kenali Kami
              </Link>
            </div>
          </div>
