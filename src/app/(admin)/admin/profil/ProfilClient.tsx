...
export default function ProfilClient() {
  ...
  const [formData, setFormData] = useState({ id: 0, title: "", content: "", orderIndex: 0, status: "PUBLISHED" });
  ...
  const openAddModal = () => {
    setFormData({ id: 0, title: "", content: "", orderIndex: profiles.length + 1, status: "PUBLISHED" });
    setIsModalOpen(true);
  };
