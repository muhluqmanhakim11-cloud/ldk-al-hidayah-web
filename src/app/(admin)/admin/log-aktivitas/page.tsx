...
export default async function LogAktivitasPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Riwayat & Log Aktivitas</h1>
        <p className="text-gray-500 mt-1">Pantauan aktivitas terbaru dari seluruh bidang (Khusus SuperAdmin)</p>
      </div>
